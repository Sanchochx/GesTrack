...
def seed_products(categories):
    ...
    products_data = [
        ...
        {'sku': 'ELEC-001', 'name': 'Laptop HP Pavilion 15', 'category': 'Electronica',
         'cost_price': 450.00, 'sale_price': 599.99, 'stock': 25, 'reorder': 10,
