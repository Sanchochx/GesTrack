...
def admin_required(fn):
    """
    Decorador para endpoints que solo Admin puede acceder
    US-AUTH-005 CA-1: Admin tiene acceso total
...
def warehouse_manager_or_admin(fn):
    """
    Decorador para endpoints de gestión de inventario
    US-AUTH-005 CA-1: Admin y Gerente de Almacén
...
def sales_staff_or_admin(fn):
    """
    Decorador para endpoints de ventas
    US-AUTH-005 CA-1: Admin y Personal de Ventas

    Uso:
        @sales_staff_or_admin
        def endpoint():
            pass
    """
